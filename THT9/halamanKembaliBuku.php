...
<?php
// menyertakan file kembaliBuku.php
require_once('kembaliBuku.php');

// menginisiasi buku di perpustakaan
$buku1 = new kembaliBuku('Laut Bercerita', 'Leila S. Chudori');
$buku2 = new kembaliBuku('Bulan', 'Tere Liye');
$buku3 = new kembaliBuku('Gadis Kretek', 'Ratih Kumala');
...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    if (isset($_GET['action']) && isset($_GET['buku'])) {
        ...
        switch ($buku) {
            case 'buku1':
                $pesan = ($action == 'pengembalian') ? $buku1->pengembalian() : $buku1->pengembalian();
                break;
            case 'buku2':
                $pesan = ($action == 'pengembalian') ? $buku2->pengembalian() : $buku2->pengembalian();
                break;
            case 'buku3':
                $pesan = ($action == 'pengembalian') ? $buku3->pengembalian() : $buku3->pengembalian();
                break;
            default:
        ...
        <div class="content">
            <div class="gallery">
                ...
                <div class="desc">Laut Bercerita oleh Leila S. Chudori
                    ...
                    <a href="?action=pengembalian&buku=buku1">Kembalikan</a><br></div>
                </div>
            ...
            <div class="gallery">
                ...
                <a href="?action=pengembalian&buku=buku2">Kembalikan</a><br></div>
                </div>
            </div>
            ...
            <div class="gallery">
                ...
                <a href="?action=pengembalian&buku=buku3">Kembalikan</a><br>
                </div>
            </div> 
        </div>
    </div>
